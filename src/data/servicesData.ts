...
export const MAIN_SERVICES: MainServiceData[] = [
  {
    ...
    heroHeadline: "Reliable Road Transportation Across India",
    ...
    heroDescription: "End-to-end transportation solutions for FTL, PTL, containerized, ODC, heavy-haul and industrial cargo across India.",
    heroImage: "https://res.cloudinary.com/uorctww6/image/upload/v1789377046/arrowline/general/road-transport.jpg",
