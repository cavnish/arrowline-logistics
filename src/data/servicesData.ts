...
const roadSubServices: SubServiceData[] = [
  {
    ...
    applications: [
      { title: "Import Cargo Containers", desc: "Raw materials, machinery parts, and chemicals from international origins.", image: "/images/road-transport.jpg" },
      { title: "Export Finished Goods", desc: "Factory packed containers moved under customs seal to Mundra port terminals.", image: "/images/hero-logistics.jpg" },
      { title: "Reefer & Specialized Containers", desc: "Temperature-sensitive pharmaceuticals, food products, and perishables.", image: "/images/project-port.jpg" },
      { title: "Domestic Containerized Freight", desc: "Inter-state commercial goods moved securely in closed standard boxes.", image: "/images/project-warehouse.jpg" },
    ],
    ...
    gallery: [
      { id: "c1", url: "/images/road-transport.jpg", title: "Container Flatbed Fleet", caption: "High-cube container movement across Gujarat highway" },
      { id: "c2", url: "/images/hero-logistics.jpg", title: "Port Gate Integration", caption: "Mundra terminal gate-out and dispatch" },
      { id: "c3", url: "/images/project-port.jpg", title: "Terminal Loading", caption: "Container crane loading onto Arrowline chassis" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Industrial Raw Materials", desc: "Steel coils, chemical drums, plastic resins, and packaging materials.", image: "/images/road-transport.jpg" },
      { title: "Finished Commercial Goods", desc: "Consumer appliances, retail inventories, and FMCG carton dispatches.", image: "/images/project-warehouse.jpg" },
      { title: "Automotive Parts & Assemblies", desc: "JIT supply chain components delivered direct to assembly plant lines.", image: "/images/hero-logistics.jpg" },
      { title: "Heavy Machinery Spares", desc: "Replacement tooling, pumps, motors, and hydraulic engineering units.", image: "/images/project-port.jpg" },
    ],
    ...
    gallery: [
      { id: "f1", url: "/images/road-transport.jpg", title: "FTL Fleet in Transit", caption: "High-speed road freight on Western corridor" },
      { id: "f2", url: "/images/project-warehouse.jpg", title: "Warehouse Loading", caption: "Safe loading and weight distribution check" },
    ],
  ...
  },
  {
    ...
    aboutImage: "/images/project-cargo.jpg",
    capabilities: [
    ...
    applications: [
      { title: "Power Transformers & Turbines", desc: "Heavy electrical generation equipment for power plants and sub-stations.", image: "/images/project-cargo.jpg" },
      { title: "Industrial Boilers & Pressure Vessels", desc: "Oversized autoclaves, reactors, and distillation columns for process plants.", image: "/images/project-port.jpg" },
      { title: "Wind Turbine Components", desc: "Tower sections, heavy nacelles, and extra-long blades transported to wind farms.", image: "/images/hero-logistics.jpg" },
      { title: "Heavy Earthmoving Equipment", desc: "Excavators, piling rigs, and mining machinery moved between infrastructure sites.", image: "/images/road-transport.jpg" },
    ],
    ...
    gallery: [
      { id: "o1", url: "/images/project-cargo.jpg", title: "Multi-Axle Heavy Movement", caption: "Heavy turbine transit on hydraulic modular trailer" },
      { id: "o2", url: "/images/project-port.jpg", title: "Port Crane Tandem Lift", caption: "Heavy ODC cargo offloading at Mundra Port" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Solar & Renewable Farms", desc: "Transformers, inverters, tracker structures, and containerized PV modules.", image: "/images/project-cargo.jpg" },
      { title: "Refinery & Petrochemical Units", desc: "High-pressure reactors, heat exchangers, pipes, and modular skids.", image: "/images/hero-logistics.jpg" },
      { title: "Cement & Steel Plants", desc: "Kiln sections, grinding mills, structural steel frames, and conveyor belts.", image: "/images/project-port.jpg" },
      { title: "Metro & Infrastructure Projects", desc: "Tunnel boring machine (TBM) parts, pre-cast girder carriers, and bridge components.", image: "/images/road-transport.jpg" },
    ],
    ...
    gallery: [
      { id: "p1", url: "/images/project-cargo.jpg", title: "Project Convoy", caption: "Industrial project equipment transit across Gujarat" },
      { id: "p2", url: "/images/hero-logistics.jpg", title: "Port Yard Staging", caption: "Project packages staged near Mundra port" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Steel Plates, Coils & Beams", desc: "High-density steel products secured with specialized coil cradles and chains.", image: "/images/road-transport.jpg" },
      { title: "Construction & Mining Vehicles", desc: "Tracked excavators, wheel loaders, road rollers, and asphalt pavers.", image: "/images/project-cargo.jpg" },
      { title: "Pre-cast Concrete Structures", desc: "Long bridge beams, building pillars, and infrastructural pre-cast slabs.", image: "/images/hero-logistics.jpg" },
      { title: "Industrial Chillers & Motors", desc: "Factory HVAC equipment, heavy diesel generator sets, and industrial compressors.", image: "/images/project-port.jpg" },
    ],
    ...
    gallery: [
      { id: "t1", url: "/images/road-transport.jpg", title: "Multi-Axle Trailer in Transit", caption: "Heavy payload trailer movement across national corridor" },
      { id: "t2", url: "/images/project-cargo.jpg", title: "Low-Bed Trailer", caption: "Low-bed chassis carrying oversized industrial equipment" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "CNC Machines & Lathes", desc: "High-precision computer numerical control machining centers and laser cutters.", image: "/images/road-transport.jpg" },
      { title: "Plastic Injection Molding Units", desc: "Heavy hydraulic clamping units, molds, and auxiliary drying machinery.", image: "/images/project-cargo.jpg" },
      { title: "Textile & Spinning Machinery", desc: "Carding machines, ring frames, and automated knitting looms.", image: "/images/project-warehouse.jpg" },
      { title: "Pumps, Compressors & Turbines", desc: "Industrial fluid handling pumps, air compressors, and electrical motors.", image: "/images/project-port.jpg" },
    ],
    ...
    gallery: [
      { id: "m1", url: "/images/road-transport.jpg", title: "CNC Machinery Transit", caption: "High-value precision machine secured on Arrowline flatbed" },
      { id: "m2", url: "/images/project-port.jpg", title: "Port Clearance Direct", caption: "Direct loading of import machinery at Mundra Port" },
    ],
...
const railSubServices: SubServiceData[] = [
  {
    ...
    aboutImage: "/images/rail-multimodal.jpg",
    capabilities: [
    ...
    applications: [
      { title: "Containerized Import Cargo", desc: "High-volume container rakes moving from Mundra to Delhi NCR, Ludhiana, and Jaipur.", image: "/images/rail-multimodal.jpg" },
      { title: "Steel & Metallurgical Freight", desc: "Coils, billets, structural steel, and TMT bars moved in bulk open wagons.", image: "/images/project-cargo.jpg" },
      { title: "Minerals, Coal & Fertilizer", desc: "Bulk agricultural commodities, soda ash, cement, and chemical raw materials.", image: "/images/road-transport.jpg" },
      { title: "Finished Industrial Goods", desc: "Palletized consumer goods and automotive components in covered rail wagons.", image: "/images/project-warehouse.jpg" },
    ],
    ...
    gallery: [
      { id: "rf1", url: "/images/rail-multimodal.jpg", title: "Container Train Rake", caption: "Double-stack container train leaving Mundra port siding" },
      { id: "rf2", url: "/images/project-port.jpg", title: "ICD Rail Terminal", caption: "Gantry crane offloading at inland container depot" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Import Raw Materials", desc: "Chemicals, polymers, metal scrap, paper pulp, and manufacturing inputs in 20ft/40ft boxes.", image: "/images/rail-multimodal.jpg" },
      { title: "Export Finished Products", desc: "Automotive parts, textiles, garments, tiles, and machinery moved under export seal.", image: "/images/hero-logistics.jpg" },
      { title: "Solar Module Shipments", desc: "High-volume containerized solar panels and inverters for utility-scale solar parks.", image: "/images/project-cargo.jpg" },
      { title: "Consumer Goods & Electronics", desc: "Retail inventories and consumer appliances destined for major consumption centers.", image: "/images/project-warehouse.jpg" },
    ],
    ...
    gallery: [
      { id: "cr1", url: "/images/rail-multimodal.jpg", title: "Double-Stack Container Train", caption: "High-capacity container train moving on Dedicated Freight Corridor" },
      { id: "cr2", url: "/images/hero-logistics.jpg", title: "Mundra Port Rail Siding", caption: "Container crane loading direct from port stack" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Cement & Clinker", desc: "Bulk cement and clinker transported from manufacturing plants to distribution hubs.", image: "/images/rail-multimodal.jpg" },
      { title: "Steel Billets, Coils & TMT", desc: "Finished and semi-finished steel products moved from mills to industrial markets.", image: "/images/project-cargo.jpg" },
      { title: "Fertilizers & Agro Commodities", desc: "Urea, DAP, potash, and food grains moved in covered BCN wagons under dry protection.", image: "/images/road-transport.jpg" },
      { title: "Coal, Minerals & Ores", desc: "Raw materials for thermal power plants, foundries, and metallurgical smelters.", image: "/images/project-port.jpg" },
    ],
    ...
    gallery: [
      { id: "ftl1", url: "/images/rail-multimodal.jpg", title: "Full Train Load Rake", caption: "Dedicated bulk freight rake moving across Western corridor" },
      { id: "ftl2", url: "/images/project-cargo.jpg", title: "Steel Rake Loading", caption: "Mechanized steel coil loading onto flat rail wagons" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Heavy Industrial Components", desc: "Machinery, castings, and fabricated assemblies moving between manufacturing states.", image: "/images/rail-multimodal.jpg" },
      { title: "Fast-Moving Consumer Goods", desc: "Palletized packaged goods moving from western production hubs to northern consumption zones.", image: "/images/project-warehouse.jpg" },
      { title: "Import Raw Materials", desc: "Port containers transferred from Mundra vessel direct to inland factories.", image: "/images/hero-logistics.jpg" },
      { title: "Automotive Parts & Engines", desc: "Synchronized JIT supply chain components moving between auto clusters.", image: "/images/project-cargo.jpg" },
    ],
    ...
    gallery: [
      { id: "mr1", url: "/images/rail-multimodal.jpg", title: "Multimodal Terminal Hub", caption: "Synchronized road-rail container transfer at dry port" },
      { id: "mr2", url: "/images/road-transport.jpg", title: "First-Mile Road Haulage", caption: "Arrowline trailer delivering container to rail siding" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "High-Value Electronic Goods", desc: "Sealed container movement protecting sensitive electronics from moisture and pilferage.", image: "/images/rail-multimodal.jpg" },
      { title: "Chemicals & Liquid ISO Tanks", desc: "Specialized liquid chemical ISO tank containers moved safely without transfer pumping.", image: "/images/project-port.jpg" },
      { title: "Automotive Parts & Engines", desc: "Crated automotive components moving under factory seal to assembly plants.", image: "/images/hero-logistics.jpg" },
      { title: "FMCG & Packaged Foods", desc: "Clean container boxes preserving packaged food quality across multi-state transit.", image: "/images/project-warehouse.jpg" },
    ],
    ...
    gallery: [
      { id: "ir1", url: "/images/rail-multimodal.jpg", title: "Intermodal Rail Flatcar", caption: "Standardized container secured with twist-locks on rail wagon" },
      { id: "ir2", url: "/images/project-port.jpg", title: "Reach Stacker Transfer", caption: "Rapid container transfer between rail wagon and road chassis" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Steel Plates, Billets & Coils", desc: "Finished industrial steel products moved on heavy flatbed wagons with stanchions.", image: "/images/rail-multimodal.jpg" },
      { title: "Coal & Coke", desc: "Thermal and coking coal for power plants, foundries, and steel manufacturers.", image: "/images/project-cargo.jpg" },
      { title: "Fertilizers (Urea / DAP)", desc: "Bagged and bulk fertilizer shipments moved in covered waterproof BCN rakes.", image: "/images/road-transport.jpg" },
      { title: "Minerals & Industrial Sand", desc: "Bauxite, gypsum, silica sand, and bentonite clay for manufacturing plants.", image: "/images/project-port.jpg" },
    ],
    ...
    gallery: [
      { id: "bi1", url: "/images/rail-multimodal.jpg", title: "Bulk Freight Train", caption: "Heavy industrial bulk rake moving along electrified rail corridor" },
      { id: "bi2", url: "/images/project-cargo.jpg", title: "Steel Wagon Loading", caption: "Mechanized gantry crane loading steel coils onto rail flatcars" },
    ],
...
const projectCargoSubServices: SubServiceData[] = [
  {
    ...
    applications: [
      { title: "Power Transformers & Turbines", desc: "Heavy electrical generation transformers and steam turbines for power grids.", image: "/images/project-cargo.jpg" },
      { title: "Petrochemical Reactors & Columns", desc: "High-pressure catalytic reactors, distillation columns, and flare stacks.", image: "/images/hero-logistics.jpg" },
      { title: "Wind Turbine Nacelles & Blades", desc: "Heavy wind turbine nacelles and extra-long wind turbine rotor blades.", image: "/images/project-port.jpg" },
      { title: "Foundry & Steel Mill Presses", desc: "Heavy hydraulic press frames, forging hammers, and continuous casting rollers.", image: "/images/road-transport.jpg" },
    ],
    ...
    gallery: [
      { id: "ho1", url: "/images/project-cargo.jpg", title: "Heavy Transformer Transit", caption: "280 MT power transformer on 18-axle hydraulic puller" },
      { id: "ho2", url: "/images/hero-logistics.jpg", title: "Vessel Under-Hook Loading", caption: "Heavy reactor discharge direct onto Arrowline modular trailer" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Steel Pipes & Tubing", desc: "Oil and gas pipelines, water transmission pipes, and casing strings.", image: "/images/project-cargo.jpg" },
      { title: "Structural Steel & Girders", desc: "Heavy building trusses, bridge sections, and industrial plant structural members.", image: "/images/hero-logistics.jpg" },
      { title: "Crated Industrial Machinery", desc: "Factory machinery and components packed in heavy wooden export crates.", image: "/images/road-transport.jpg" },
      { title: "Wind Energy Towers & Hubs", desc: "Tubular steel tower segments, hub castings, and generator frames.", image: "/images/project-port.jpg" },
    ],
    ...
    gallery: [
      { id: "bb1", url: "/images/project-cargo.jpg", title: "Breakbulk Vessel Discharge", caption: "Heavy pipe bundles discharged under hook at Mundra port" },
      { id: "bb2", url: "/images/road-transport.jpg", title: "Structural Steel Transport", caption: "Heavy industrial steel trusses secured on flatbed trailer" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "CNC Machining Centers", desc: "Multi-axis milling machines, horizontal machining centers, and precision lathes.", image: "/images/project-cargo.jpg" },
      { title: "Plastic & Rubber Molding", desc: "High-tonnage injection molding machines, extrusion lines, and blow molders.", image: "/images/hero-logistics.jpg" },
      { title: "Metal Stamping & Forging", desc: "Hydraulic press frames, mechanical stamping presses, and forging hammers.", image: "/images/road-transport.jpg" },
      { title: "Industrial Boilers & Chillers", desc: "Packaged steam boilers, central chillers, air compressors, and heat exchangers.", image: "/images/project-port.jpg" },
    ],
    ...
    gallery: [
      { id: "im1", url: "/images/project-cargo.jpg", title: "Molding Machine Transit", caption: "Heavy injection molding press on low-bed trailer" },
      { id: "im2", url: "/images/road-transport.jpg", title: "CNC Machine Delivery", caption: "Precision CNC center delivered directly to factory bay" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Heavy Power Transformers", desc: "200 MT to 350 MT generating transformers moved on modular multi-axles.", image: "/images/project-cargo.jpg" },
      { title: "Chemical & Refinery Reactors", desc: "Extra-diameter pressure vessels carried in drop-deck well beds.", image: "/images/hero-logistics.jpg" },
      { title: "Turbine Rotors & Generators", desc: "High-density power generation equipment moved from port to power plant site.", image: "/images/project-port.jpg" },
      { title: "Pre-cast Bridge Girders", desc: "Extra-long concrete and steel girders moved on extendable steerable trailers.", image: "/images/road-transport.jpg" },
    ],
    ...
    gallery: [
      { id: "ma1", url: "/images/project-cargo.jpg", title: "24-Axle Hydraulic Puller", caption: "Heavy refinery reactor moving on coupled modular axles" },
      { id: "ma2", url: "/images/hero-logistics.jpg", title: "Drop-Deck Configuration", caption: "Drop-deck trailer carrying large diameter pressure vessel" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Utility Solar & Wind Parks", desc: "Complete logistics for solar parks and wind farms across Gujarat, Rajasthan, and MP.", image: "/images/project-cargo.jpg" },
      { title: "Refinery Expansion Projects", desc: "Multi-package turnkey transport for petrochemical complexes and gas processing plants.", image: "/images/hero-logistics.jpg" },
      { title: "Steel & Metallurgical Plants", desc: "Heavy machinery, rolling mills, furnaces, and structural packages for steel mills.", image: "/images/project-port.jpg" },
      { title: "Chemical & Fertilizer Units", desc: "High-pressure synthesis loops, reactors, storage tanks, and modular process skids.", image: "/images/road-transport.jpg" },
    ],
    ...
    gallery: [
      { id: "e2e1", url: "/images/project-cargo.jpg", title: "Turnkey Project Execution", caption: "Complete project cargo convoy arriving at industrial site" },
      { id: "e2e2", url: "/images/hero-logistics.jpg", title: "Site Foundation Placement", caption: "Heavy equipment tandem crane placement onto plant foundation" },
    ],
...
const warehousingSubServices: SubServiceData[] = [
  {
    ...
    aboutImage: "/images/project-warehouse.jpg",
    capabilities: [
    ...
    applications: [
      { title: "Industrial Raw Materials", desc: "Chemical bags, polymer pellets, rubber bales, and mineral sacks in dry covered bays.", image: "/images/project-warehouse.jpg" },
      { title: "Finished Manufactured Goods", desc: "Palletized consumer appliances, packaging supplies, and electrical equipment.", image: "/images/road-transport.jpg" },
      { title: "Steel Plates, Coils & Pipes", desc: "Heavy metallurgical products stored securely in our heavy-duty yard storage.", image: "/images/project-cargo.jpg" },
      { title: "Import Project Staging", desc: "Capital goods held in buffer storage prior to phased project site erection.", image: "/images/project-port.jpg" },
    ],
    ...
    gallery: [
      { id: "gw1", url: "/images/project-warehouse.jpg", title: "Covered Warehouse Interior", caption: "High-clearance racked industrial storage facility" },
      { id: "gw2", url: "/images/road-transport.jpg", title: "Loading Dock Bay", caption: "Multi-trailer dock loading and unloading operations" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "FMCG & Consumer Goods", desc: "Bulk receiving, carton picking, and daily store replenishment across retail networks.", image: "/images/project-warehouse.jpg" },
      { title: "Automotive Spare Parts", desc: "Kitting and distributing spare parts direct to regional dealer service workshops.", image: "/images/road-transport.jpg" },
      { title: "Industrial Hardware & Tools", desc: "Sorting and dispatching industrial tools and components to construction contractors.", image: "/images/project-cargo.jpg" },
      { title: "Chemical & Lubricant Packaging", desc: "Palletizing and distributing drums and containers to regional distributors.", image: "/images/hero-logistics.jpg" },
    ],
    ...
    gallery: [
      { id: "df1", url: "/images/project-warehouse.jpg", title: "Fulfillment Packing Station", caption: "High-accuracy order picking and pallet wrapping" },
      { id: "df2", url: "/images/road-transport.jpg", title: "Outbound Dispatch Loading", caption: "Palletized orders loading onto regional distribution fleet" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Raw Material Buffer Stock", desc: "Managing safety stock of critical industrial chemicals, metals, and components near ports.", image: "/images/project-warehouse.jpg" },
      { title: "Batch-Controlled Polymers", desc: "Tracking resin melt-flow grades, heat numbers, and manufacturing batch numbers.", image: "/images/road-transport.jpg" },
      { title: "High-Value Capital Spares", desc: "Individual serial number tracking for expensive machine replacement tooling.", image: "/images/project-cargo.jpg" },
      { title: "Commercial Finished Inventory", desc: "Managing multi-SKU retail and wholesale stock ready for rapid dispatch.", image: "/images/hero-logistics.jpg" },
    ],
    ...
    gallery: [
      { id: "im1", url: "/images/project-warehouse.jpg", title: "Barcode Scanner In Action", caption: "Warehouse team scanning inventory during location putaway" },
      { id: "im2", url: "/images/road-transport.jpg", title: "Organized Racked Storage", caption: "Systematic pallet racking with clear aisle location markers" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Import Container Buffer", desc: "Holding import containers outside port to avoid port demurrage while customs clears.", image: "/images/project-warehouse.jpg" },
      { title: "Export Cargo Stuffing", desc: "Consolidating factory cargo and stuffing into export shipping containers.", image: "/images/hero-logistics.jpg" },
      { title: "Flat-Rack & Open-Top Handling", desc: "Handling heavy machinery and ODC cargo mounted on specialized container equipment.", image: "/images/project-cargo.jpg" },
      { title: "Empty Box Repositioning", desc: "Short-term storage and depot management for shipping lines and leasing companies.", image: "/images/project-port.jpg" },
    ],
    ...
    gallery: [
      { id: "cs1", url: "/images/project-warehouse.jpg", title: "Reach Stacker Container Lift", caption: "Heavy reach stacker stacking 40ft containers in yard" },
      { id: "cs2", url: "/images/hero-logistics.jpg", title: "Container De-stuffing Dock", caption: "Cargo de-stuffing at covered warehouse dock" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Palletized Industrial Cargo", desc: "Fast unloading of shrink-wrapped pallets using counterbalanced forklift trucks.", image: "/images/project-warehouse.jpg" },
      { title: "Heavy Machinery & Crates", desc: "Mobile crane and heavy forklift handling of machinery weighing up to 25 MT.", image: "/images/project-cargo.jpg" },
      { title: "Chemical Drums & Carboys", desc: "Safe handling of liquid chemicals using hydraulic drum clamp attachments.", image: "/images/hero-logistics.jpg" },
      { title: "Steel Coils & Long Bundles", desc: "Boom and crane handling of steel coils, rebar bundles, and long pipes.", image: "/images/road-transport.jpg" },
    ],
    ...
    gallery: [
      { id: "lu1", url: "/images/project-warehouse.jpg", title: "Forklift Pallet Loading", caption: "Heavy forklift loading palletized cargo at dock" },
      { id: "lu2", url: "/images/road-transport.jpg", title: "Crane Rigging Operation", caption: "Heavy crane loading industrial machinery onto flatbed trailer" },
    ],
...
export const MAIN_SERVICES: MainServiceData[] = [
  {
    ...
    applications: [
      { title: "ISO Shipping Containers", desc: "20ft and 40ft import/export shipping boxes moved under port customs pass.", image: "/images/road-transport.jpg" },
      { title: "Industrial Machinery", desc: "Factory production machinery, CNC units, and precision engineering parts.", image: "/images/project-cargo.jpg" },
      { title: "Over Dimensional Cargo (ODC)", desc: "Transformers, boilers, turbines, and large industrial pressure vessels.", image: "/images/hero-logistics.jpg" },
      { title: "Steel & Metallurgical Freight", desc: "Steel coils, plates, beams, structural sections, and pipeline bundles.", image: "/images/project-port.jpg" },
      { title: "Automotive Assemblies", desc: "Engines, stampings, and automotive parts delivered JIT to assembly plants.", image: "/images/project-warehouse.jpg" },
      { title: "Commercial & FMCG Freight", desc: "Packaged consumer goods and industrial materials moved across regional hubs.", image: "/images/road-transport.jpg" },
    ],
    ...
    gallery: [
      { id: "mr1", url: "/images/road-transport.jpg", title: "Pan-India Road Fleet", caption: "Arrowline heavy trailer moving on Western corridor" },
      { id: "mr2", url: "/images/project-cargo.jpg", title: "Heavy ODC Transit", caption: "Hydraulic multi-axle trailer carrying industrial equipment" },
      { id: "mr3", url: "/images/hero-logistics.jpg", title: "Mundra Port Operations", caption: "Container haulage dispatch from Mundra Port terminal" },
      { id: "mr4", url: "/images/project-warehouse.jpg", title: "Factory Dock Loading", caption: "Scheduled FTL loading at manufacturing warehouse" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Import Containerized Cargo", desc: "20ft and 40ft container trains moving from Mundra to Northern ICD dry ports.", image: "/images/rail-multimodal.jpg" },
      { title: "Steel Billets & Heavy Coils", desc: "High-tonnage industrial steel products moved on heavy-duty railway flatcars.", image: "/images/project-cargo.jpg" },
      { title: "Bulk Minerals, Ores & Coal", desc: "Raw materials for thermal power plants, metallurgical smelters, and chemical units.", image: "/images/project-port.jpg" },
      { title: "Cement, Clinker & Aggregates", desc: "Bulk building materials moved from plants directly to regional distribution sidings.", image: "/images/road-transport.jpg" },
      { title: "Fertilizers & Agriculture", desc: "Urea, DAP, and food grains moved in covered waterproof BCN wagons across India.", image: "/images/project-warehouse.jpg" },
      { title: "Automotive Components", desc: "Crated automotive parts and sub-assemblies moving between manufacturing clusters.", image: "/images/hero-logistics.jpg" },
    ],
    ...
    gallery: [
      { id: "mrail1", url: "/images/rail-multimodal.jpg", title: "Dedicated Container Train", caption: "Double-stack container train on Western Dedicated Freight Corridor" },
      { id: "mrail2", url: "/images/project-port.jpg", title: "Rail Siding Gantry", caption: "High-speed gantry crane transferring containers at Mundra railhead" },
      { id: "mrail3", url: "/images/project-cargo.jpg", title: "Steel Flatcar Rake", caption: "Heavy industrial steel coils secured on railway flatcars" },
      { id: "mrail4", url: "/images/hero-logistics.jpg", title: "Port Rail Terminal", caption: "Mundra Port intermodal rail facility" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Power Transformers & Turbines", desc: "Heavy electrical generation transformers, steam turbines, and generators.", image: "/images/project-cargo.jpg" },
      { title: "Refinery Columns & Reactors", desc: "High-pressure catalytic reactors, distillation columns, and chemical skids.", image: "/images/hero-logistics.jpg" },
      { title: "Wind Energy Components", desc: "Heavy nacelles, tower sections, and long rotor blades moved to wind farms.", image: "/images/project-port.jpg" },
      { title: "Heavy Foundry & Stamping Presses", desc: "Multi-hundred-ton hydraulic forging presses and industrial casting units.", image: "/images/road-transport.jpg" },
      { title: "TBM & Infrastructure Parts", desc: "Tunnel boring machines, pre-cast bridge girders, and metro construction equipment.", image: "/images/project-warehouse.jpg" },
      { title: "Steel Mill Machinery", desc: "Rolling mills, continuous casting rollers, and heavy structural assemblies.", image: "/images/project-cargo.jpg" },
    ],
    ...
    gallery: [
      { id: "mpc1", url: "/images/project-cargo.jpg", title: "Heavy Transformer Haulage", caption: "280 MT power transformer moving on 18-axle hydraulic puller" },
      { id: "mpc2", url: "/images/hero-logistics.jpg", title: "Port Direct Discharge", caption: "Heavy reactor vessel offloaded direct to Arrowline trailer" },
      { id: "mpc3", url: "/images/project-port.jpg", title: "Tandem Crane Lifting", caption: "Precision tandem crane lifting for industrial project equipment" },
      { id: "mpc4", url: "/images/road-transport.jpg", title: "Wind Energy Transport", caption: "Wind turbine components transit across Rajasthan highway" },
    ],
  ...
  },
  {
    ...
    applications: [
      { title: "Industrial Raw Materials", desc: "Chemical bags, polymer pellets, rubber bales, and mineral sacks in covered bays.", image: "/images/project-warehouse.jpg" },
      { title: "Finished Commercial Goods", desc: "Palletized consumer appliances, packaging materials, and retail products.", image: "/images/road-transport.jpg" },
      { title: "Import Containers & Equipment", desc: "20ft and 40ft containers staged in our off-dock yard to eliminate port demurrage.", image: "/images/project-port.jpg" },
      { title: "Structural Steel & Pipes", desc: "Heavy metallurgical products and bundles stored securely in our heavy open yard.", image: "/images/project-cargo.jpg" },
      { title: "Automotive Parts & Spares", desc: "Organized racked storage for automotive parts ready for JIT factory replenishment.", image: "/images/hero-logistics.jpg" },
      { title: "Project Staging Packages", desc: "Consolidated capital goods staged and sorted prior to phased installation at site.", image: "/images/project-warehouse.jpg" },
    ],
    ...
    gallery: [
      { id: "mwh1", url: "/images/project-warehouse.jpg", title: "Modern Covered Warehouse", caption: "High-clearance racked industrial storage facility near Mundra" },
      { id: "mwh2", url: "/images/road-transport.jpg", title: "Container Dock Operations", caption: "Multi-bay loading docks for rapid trailer turnaround" },
      { id: "mwh3", url: "/images/project-cargo.jpg", title: "Heavy Storage Yard", caption: "Secured open yard for heavy industrial steel and machinery" },
      { id: "mwh4", url: "/images/hero-logistics.jpg", title: "Forklift Handling Station", caption: "Precision forklift pallet handling inside facility" },
    ],
