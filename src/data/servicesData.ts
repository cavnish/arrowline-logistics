...
const roadSubServices: SubServiceData[] = [
  {
    ...
    shortDesc: "Dedicated 20ft and 40ft container chassis transport from Mundra Port to Delhi-NCR, Jaipur, Ahmedabad, Mumbai, Pune, Indore, and pan-India industrial corridors.",
    heroHeadline: "Mundra Port Container Transportation & Pan-India Haulage",
    heroSubheadline: "Port-to-factory container transport from Mundra Port with guaranteed 20ft/40ft chassis availability, customs clearance sync, and real-time GPS tracking across India.",
    heroBadge: "ROAD TRANSPORTATION • MUNDRA CONTAINER HAULAGE",
    heroImage: "https://res.cloudinary.com/uorctww6/image/upload/v1789377042/arrowline/general/project-port.jpg",
    aboutBadge: "MUNDRA CONTAINER TRANSPORT",
    aboutHeading: "Connecting Mundra Port Directly to Factory Floors & Inland Dry Ports.",
    aboutDescription: "Arrowline Logistics is an authorized Mundra container transporter providing specialized container transportation services designed for import, export, and domestic containerized movements. Operating directly out of Mundra Port terminals and regional inland container depots (ICDs), our fleet of dedicated container trailers ensures timely pickup, secure twist-lock chassis transit, and seamless dock delivery to Delhi, Jaipur, Ahmedabad, Mumbai, Pune, Indore, Bengaluru, and nationwide destinations without handling risk.",
    aboutBulletPoints: [
      "Dedicated 20-ft and 40-ft high-cube flatbed and skeletal container chassis fleet",
      "Direct Mundra Port gate-in and gate-out coordination with electronic port passes",
      "High-frequency container corridors: Mundra to Delhi-NCR, Jaipur, Ahmedabad, Mumbai, Pune, and Central/South India",
      "Factory de-stuffing & round-trip empty container return to shipping line yards",
      "Live GPS tracking with automated geofenced trip milestone alerts and digital e-POD",
    ],
    ...
    capabilities: [
      ...
      { title: "Port-to-Destination Corridors", desc: "Direct highway dispatch from Mundra Port to Delhi-NCR, Rajasthan, Maharashtra, Gujarat, and South India." },
    ...
    faqs: [
      { q: "What routes are served for container transport from Mundra Port?", a: "Arrowline operates daily high-frequency container transport routes from Mundra Port to Delhi / Delhi-NCR, Jaipur, Ahmedabad, Mumbai, Pune, Indore, Bhopal, Bengaluru, Hyderabad, Chennai, and Kolkata, as well as inland industrial clusters across Rajasthan, Gujarat, Maharashtra, and Madhya Pradesh." },
      { q: "What types of containers can Arrowline transport from Mundra Port?", a: "We transport all standard ISO containers including 20-foot, 40-foot standard, 40-foot High Cube (HC), flat-rack, open-top, and specialized temperature-controlled reefer containers." },
      { q: "How quickly can trailers be deployed at Mundra Port?", a: "With our primary operational desk stationed directly at Mundra Port, Gujarat, we deploy dedicated container chassis within 2 to 4 hours of customs clearance and terminal release." },
      { q: "Do you handle empty container return to shipping line yards?", a: "Yes. Our container transportation service includes complete round-trip coordination: delivering the laden container to your factory dock and promptly returning the empty box to the designated shipping line depot to prevent detention fees." },
      { q: "Can Arrowline handle heavy payload containers and rail multimodal connectivity?", a: "Yes. We operate heavy-duty multi-axle trailers compliant with NHAI regulations, and coordinate multimodal container rail links via the Western Dedicated Freight Corridor (WDFC) for long-haul transit to North India." },
    ],
    gallery: [
    ...
    seoTitle: "Mundra Port Container Transportation | Dedicated 20ft & 40ft Chassis | Arrowline",
    seoDesc: "Specialized container transport from Mundra Port across India. Dedicated 20ft/40ft chassis fleet to Delhi-NCR, Jaipur, Ahmedabad, Mumbai, Pune & Pan-India destinations.",
    isPublished: true,
    displayOrder: 1,
  },
  {
    ...
    shortDesc: "Full Truckload (FTL) and Less-than-Truckload (LTL) road freight solutions connecting Mundra Port, Gujarat, Rajasthan, Delhi-NCR, Maharashtra, and Pan-India.",
    heroHeadline: "Dedicated FTL & LTL Road Transportation Across India",
    heroSubheadline: "High-velocity full truckload and consolidated freight services from Mundra Port and Gujarat manufacturing corridors to North, Central, Western, and Southern India.",
    ...
    aboutHeading: "Flexible FTL & LTL Freight Solutions Built for Industrial Volume.",
    aboutDescription: "Arrowline Logistics provides comprehensive Full Truckload (FTL) and Less-than-Truckload (LTL) truck transportation connecting Mundra Port and Gujarat manufacturing belts to nationwide trade destinations. Whether dispatching dedicated multi-ton vehicles for urgent Gujarat to Rajasthan, Gujarat to Delhi, or Gujarat to Maharashtra movements, or managing scheduled linehaul freight, our fleet delivers punctual transit with zero co-loading damage.",
    aboutBulletPoints: [
      "Dedicated Full Truckload (FTL) vehicles ranging from 9 MT to 40 MT capacity",
      "Primary express corridors: Gujarat → Rajasthan, Gujarat → Delhi-NCR, Gujarat → Maharashtra, and Central India",
    ...
    faqs: [
      { q: "What are your primary FTL transportation routes from Gujarat and Mundra Port?", a: "Our core FTL freight corridors include Mundra / Gujarat to Delhi-NCR, Jaipur, Mumbai, Pune, Indore, Bhopal, Bengaluru, Hyderabad, and Chennai, providing direct point-to-point transit with verified commercial drivers." },
    ...
    seoTitle: "FTL & LTL Transportation Services India | Road Freight from Mundra | Arrowline",
    seoDesc: "Full Truckload (FTL) and Part Truckload (LTL) truck transportation across India from Mundra Port and Gujarat. Direct corridors to Delhi, Rajasthan, Maharashtra & Pan-India.",
    isPublished: true,
    displayOrder: 2,
  },
  {
    ...
    shortDesc: "Engineered ODC transportation and heavy haulage from Mundra Port across India. Hydraulic modular multi-axles, route surveys, and statutory permits for oversized engineering cargo.",
    heroHeadline: "ODC Transportation & Heavy Haulage from Mundra Port",
    heroSubheadline: "Heavy-lift road freight engineering, route feasibility surveys, multi-axle hydraulic pullers, and turnkey transit coordination from Mundra Port across India.",
    ...
    aboutHeading: "Safely Moving Oversized & Super-Heavy Cargo from Mundra Port Across India.",
    aboutDescription: "Over Dimensional Cargo (ODC) requires specialized engineering, meticulous route planning, and robust heavy-haulage equipment. Arrowline Logistics specializes in transporting oversized industrial equipment, boilers, transformers, and structural components from Mundra Port and Gujarat industrial zones to project locations across Maharashtra, Rajasthan, Madhya Pradesh, Karnataka, and Pan-India. We manage everything from civil bridge surveys and statutory permits to multi-axle trailer deployment and escort coordination.",
    aboutBulletPoints: [
      "Hydraulic multi-axle trailers, low-bed, semi-low bed, and modular puller units",
      "Route feasibility surveys checking overhead bridge clearances, turns, and toll lanes from Mundra Port",
      "Statutory MoRTH and NHAI permissions for over-dimensional road movement across state borders",
    ...
    faqs: [
      { q: "What qualifies as Over Dimensional Cargo (ODC) from Mundra Port?", a: "In India, cargo exceeding standard dimensions (Length > 12m, Width > 2.6m, Height > 3.8m, or Gross Weight > 40-49 MT depending on axle count) is classified as ODC. From Mundra Port, we handle oversized import and domestic cargo using specialized hydraulic trailers and NHAI permits." },
      { q: "How long does route survey and permit approval take for ODC?", a: "A standard route feasibility survey takes 3 to 7 days depending on the corridor, while statutory NHAI online permissions generally take 5 to 10 working days." },
      { q: "What types of trailers are used for heavy haulage from Mundra?", a: "We deploy hydraulic multi-axle modular trailers (Goldhofer/Scheuerle types), semi-low beds, ultra-low beds, drop-deck trailers, and extendable telescopic trailers matched to cargo dimensions." },
    ...
    seoTitle: "ODC Transportation from Mundra | Heavy Haulage India | Arrowline",
    seoDesc: "Engineered ODC transportation and heavy haulage from Mundra Port across India. Hydraulic multi-axles, route surveys, and NHAI permits for super-heavy cargo.",
    isPublished: true,
    displayOrder: 3,
  },
  {
    ...
    shortDesc: "End-to-end highway logistics for industrial projects, refinery expansions, and turnkey plant setups from Mundra Port to project sites across India.",
    heroHeadline: "Project Cargo Transportation from Mundra Port",
    ...
    aboutHeading: "Managing Complex Project Cargo from Mundra Port to Remote Sites.",
    aboutDescription: "Project cargo transportation demands multi-stage synchronization across heavy machinery, containerized spares, fabricated structures, and sensitive electrical equipment. Arrowline Logistics manages the entire road movement lifecycle for major EPC and industrial engineering projects. Anchored at Mundra Port, we consolidate dispatches, schedule heavy convoys, and ensure zero-delay site deliveries to Rajasthan, NCR, Maharashtra, MP, and Southern project sites.",
    aboutBulletPoints: [
    ...
    faqs: [
      { q: "What does project cargo road logistics encompass from Mundra Port?", a: "Project cargo logistics encompasses the comprehensive planning, port stevedoring, route surveys, and heavy road transportation of all equipment, structures, machinery, and materials required for a specific industrial construction project from Mundra Port to the job site." },
      { q: "Can Arrowline manage staging of project cargo near Mundra Port?", a: "Yes. We provide secure open and covered staging yards near Mundra Port where import shipments can be safely inspected, grouped, and stored until the project site is ready for receipt." },
    ...
    seoTitle: "Project Cargo from Mundra Port | Turnkey Industrial Transport India | Arrowline",
    seoDesc: "Turnkey project cargo road transportation from Mundra Port across India. Staging yards, heavy convoys, route surveys, and site laydown delivery for EPC & industrial projects.",
    isPublished: true,
    displayOrder: 4,
  },
  {
    ...
    shortDesc: "Comprehensive fleet of high-capacity flatbeds, semi-low beds, low-beds, and hydraulic multi-axle trailers from Mundra Port for specialized industrial freight.",
    heroHeadline: "Trailer & Multi-Axle Transportation from Mundra Port",
    heroSubheadline: "High-tonnage vehicle deployment configured precisely for heavy industrial machinery, steel, pre-cast structures, and oversized cargo.",
    ...
    seoTitle: "Trailer & Multi-Axle Transportation India | Mundra Heavy Haulage | Arrowline",
    seoDesc: "High-capacity trailer and multi-axle transportation from Mundra Port across India. 40ft flatbeds, semi-low beds, ultra low-beds, and modular hydraulic pullers.",
    isPublished: true,
    displayOrder: 5,
  },
  {
    ...
    shortDesc: "Precision road freight for factory machinery, engineering equipment, electrical assemblies, and industrial plant consignments from Mundra Port across India.",
    heroHeadline: "Industrial Machinery & Cargo Transportation from Mundra Port",
    heroSubheadline: "Damage-free transit for high-value factory production lines, CNC machines, transformers, pumps, and precision engineering goods from Mundra Port.",
    ...
    seoTitle: "Industrial Machinery Transportation from Mundra Port & Pan-India | Arrowline",
    seoDesc: "Precision industrial transportation and road freight for machinery, CNC equipment, factory plants, and heavy engineering goods from Mundra Port across India.",
    isPublished: true,
    displayOrder: 6,
  },
];
...
const railSubServices: SubServiceData[] = [
  {
    ...
    shortDesc: "High-capacity scheduled rail freight services from Mundra Port leveraging the Western Dedicated Freight Corridor (WDFC) and Indian Railways for long-haul national cargo.",
    heroHeadline: "Rail Freight Transportation from Mundra Port",
    heroSubheadline: "Scheduled double-stack container rakes and bulk trainload freight connecting Mundra Port with Delhi-NCR, Rajasthan, Punjab, and Pan-India industrial centers.",
    ...
    aboutHeading: "Connecting Mundra Port to Inland Industrial Centers Via High-Capacity Rail.",
    aboutDescription: "Rail freight represents the most cost-effective and environmentally sustainable transport mode for moving high-volume industrial goods over distances exceeding 500 kilometers. Arrowline Logistics integrates directly with Indian Railways and container train operators (CONCOR) to deliver scheduled rail freight solutions. Operating directly out of Mundra Port, we connect maritime trade with key inland dry ports and industrial sidings across Northern, Central, and Eastern India.",
    aboutBulletPoints: [
      "Direct integration with Western Dedicated Freight Corridor (WDFC) for express transit from Mundra Port",
      "Significant cost savings of 25% to 40% compared to long-distance highway road trucking",
    ...
    faqs: [
      { q: "Why should a business choose rail freight over road transportation from Mundra?", a: "Rail freight offers substantial cost savings (often 25-40% lower on long-haul routes over 500 km), higher single-trip volume capacity (up to 2,500-3,000 MT per train load), immunity to highway traffic/weather delays, and significantly lower carbon emissions." },
    ...
    seoTitle: "Rail Freight from Mundra Port | WDFC Freight Transportation India | Arrowline",
    seoDesc: "Scheduled rail freight transportation from Mundra Port across India. WDFC corridor access, full train loads, container trains, and multimodal road-rail delivery.",
    isPublished: true,
    displayOrder: 1,
  },
  {
    ...
    shortDesc: "Scheduled container train services connecting Mundra Port to inland container depots (ICDs) across Delhi-NCR, Rajasthan, Punjab, and Central India.",
    heroHeadline: "Container Rail Transportation from Mundra Port",
    heroSubheadline: "Scheduled double-stack container rakes from Mundra Port to major inland dry ports (Dadri, Tughlakabad, Khatuwas, Jaipur, Ludhiana) for import & export cargo.",
    heroBadge: "RAIL TRANSPORTATION • CONTAINER RAIL",
    heroImage: "https://res.cloudinary.com/uorctww6/image/upload/v1789377042/arrowline/general/project-port.jpg",
    aboutBadge: "CONTAINER RAIL LOGISTICS",
    aboutHeading: "Seamless Mundra Port-to-ICD Container Movement via Dedicated Freight Corridors.",
    ...
    industries: ["International Exim Shippers", "Solar & Renewable EPCs", "Automotive & Ancillaries", "Textiles & Retail", "Chemicals & Polymers", "Heavy Steel & Metals"],
    faqs: [
      { q: "Which inland dry ports (ICDs) are served by container trains from Mundra Port?", a: "Arrowline coordinates container train services from Mundra Port to major inland container depots including ICD Dadri, ICD Tughlakabad (TKD), ICD Khatuwas, ICD Garhi Harsaru, ICD Jaipur (Kanakpura), ICD Sanand, and ICD Ludhiana." },
      { q: "How fast is container rail transit from Mundra Port to Delhi-NCR?", a: "Via the electrified Western Dedicated Freight Corridor (WDFC), double-stack container trains reach Delhi-NCR dry ports within 24 to 36 hours of train departure from Mundra." },
      { q: "Can customs duty be paid at the destination inland dry port?", a: "Yes. Import containers can move under customs bond transit from Mundra Port directly to your local destination ICD, allowing your CHA to clear customs inspection closer to your manufacturing plant." },
      { q: "Do you coordinate road delivery from the ICD to our factory dock?", a: "Yes. Our multimodal logistics team arranges seamless last-mile trailer delivery from the destination ICD directly to your factory or warehouse dock." },
      { q: "What is the advantage of double-stack container rail from Mundra?", a: "Double-stack container trains carry twice the container volume per train run on the WDFC, significantly reducing haulage costs per container and ensuring faster vessel evacuation." },
    ],
    gallery: [
      { id: "cr1", url: "https://res.cloudinary.com/uorctww6/image/upload/v1789377042/arrowline/general/project-port.jpg", title: "Double-Stack Container Rake", caption: "Double-stack container train leaving Mundra port terminal" },
      { id: "cr2", url: "https://res.cloudinary.com/uorctww6/image/upload/v1789377045/arrowline/general/rail-multimodal.jpg", title: "ICD Container Gantry", caption: "Gantry crane offloading at inland container terminal" },
    ],
    ctaHeadline: "Optimize Port-to-ICD Transit with Container Rail",
    seoTitle: "Container Rail Transportation from Mundra Port | WDFC Freight | Arrowline",
    seoDesc: "Scheduled container rail transportation from Mundra Port to Delhi-NCR, Jaipur, Ludhiana & Central India ICD dry ports via Western Dedicated Freight Corridor.",
    isPublished: true,
    displayOrder: 2,
  },
...
const warehousingSubServices: SubServiceData[] = [
  {
    ...
    shortDesc: "Secure, weather-protected covered warehousing and open industrial storage yards located near Mundra Port, Kutch, Gujarat with direct highway and rail links.",
    heroHeadline: "Industrial Warehousing Near Mundra Port & Kutch Logistics Hub",
    heroSubheadline: "Strategic covered warehouse and heavy-duty open yard storage located minutes from Mundra Port terminals for seamless buffer storage, custom staging, and nationwide distribution.",
    heroBadge: "WAREHOUSING • MUNDRA INDUSTRIAL STORAGE",
    heroImage: "https://res.cloudinary.com/uorctww6/image/upload/v1789377044/arrowline/general/project-warehouse.jpg",
    aboutBadge: "INDUSTRIAL WAREHOUSING NEAR MUNDRA",
    aboutHeading: "Secure Storage Facilities Engineered for Industrial Goods, Raw Materials & Port Buffer.",
    aboutDescription: "Modern manufacturing and trade require scalable, secure storage facilities strategically positioned close to maritime gateways and arterial highways. Arrowline Logistics provides general and industrial warehousing facilities equipped with high-load industrial flooring, modern dock levelers, 24/7 CCTV surveillance, and flexible leasing options. Located adjacent to Mundra Port in Kutch, Gujarat, our warehouses serve as ideal consolidation, buffer, and de-stuffing hubs for regional and pan-India distribution.",
    aboutBulletPoints: [
      "High-clearance covered storage with heavy-duty industrial reinforced flooring",
      "Secure open yard storage for heavy machinery, steel, pipes, and weather-tolerant industrial cargo",
      "Strategically located near Mundra Port terminals and major Gujarat highway corridors",
      "24/7 on-site physical security, perimeter fencing, and high-definition CCTV monitoring",
      "Integrated drayage from Mundra Port to eliminate expensive shipping line demurrage fees",
    ],
    ...
    faqs: [
      ...
      { q: "What types of goods can be stored in your industrial warehouses near Mundra?", a: "We store a wide variety of industrial goods including raw materials, chemicals (non-hazardous and approved classifications), machinery, steel, palletized goods, automotive components, and project cargo." },
      { q: "Do you offer both covered warehouses and open yard storage in Kutch?", a: "Yes. We offer high-ceiling weatherproof covered warehouses for moisture-sensitive goods and secure open yards for heavy machinery, steel, and containers." },
      { q: "What security measures are implemented at your Mundra warehouses?", a: "Our facilities feature 24/7 security guards, automated entry gates, perimeter boundary walls, high-definition CCTV coverage, fire protection systems, and strict visitor access controls." },
      { q: "Can we rent warehouse space on a short-term flexible basis near Mundra Port?", a: "Yes. We offer flexible commercial terms ranging from short-term spot storage for import consignments to multi-year dedicated warehouse operations." },
    ],
    gallery: [
    ...
    seoTitle: "Warehousing Near Mundra Port | Industrial Storage Kutch Gujarat | Arrowline",
    seoDesc: "Secure industrial warehousing and covered storage near Mundra Port, Kutch Gujarat. Open staging yards, 24/7 security, dock levelers, and nationwide transport links.",
    isPublished: true,
    displayOrder: 1,
  },
  {
  ...
  },
  {
    ...
    shortDesc: "Dedicated off-dock container yard storage, 45-ton reach stacker handling, container stuffing/de-stuffing, and empty box depot near Mundra Port.",
    heroHeadline: "Container Storage & Off-Dock Yard Handling Near Mundra Port",
    heroSubheadline: "Secure off-dock container yard facilities near Mundra Port offering 45-ton reach stacker handling, laden storage, container stuffing, de-stuffing, and demurrage avoidance.",
    heroBadge: "WAREHOUSING • MUNDRA CONTAINER YARD",
    heroImage: "https://res.cloudinary.com/uorctww6/image/upload/v1789377042/arrowline/general/project-port.jpg",
    aboutBadge: "CONTAINER YARD & HANDLING NEAR MUNDRA",
    aboutHeading: "Optimizing Container Flow Near Mundra Port to Eliminate Expensive Demurrage.",
    ...
    faqs: [
      { q: "Why move containers to an off-dock container yard near Mundra Port?", a: "Seaport container terminals charge high escalating ground rent after the short initial free period (typically 3-5 days). Moving containers to Arrowline's off-dock yard near Mundra Port cuts storage costs by up to 60-70% while you finalize customs clearance or inland transport." },
      ...
      { q: "What equipment is used in your Mundra container yard?", a: "We operate 45-ton heavy reach stackers, empty container handlers, heavy-duty container trailers, and specialized forklift trucks equipped with drum clamps and carpet booms." },
      { q: "Do you handle export container stuffing and lashing at Mundra?", a: "Yes. We handle professional export container stuffing, including certified timber chocking, heavy strapping, and cargo weight balancing compliant with SOLAS VGM regulations." },
    ...
    seoTitle: "Container Storage & Handling Near Mundra Port | Off-Dock Yard | Arrowline",
    seoDesc: "Off-dock container storage & handling near Mundra Port, Gujarat. 45-ton reach stacker yard, container stuffing/destuffing, demurrage avoidance & port drayage.",
    isPublished: true,
    displayOrder: 4,
  },
  {
...
export const MAIN_SERVICES: MainServiceData[] = [
  {
    ...
    shortDesc: "High-frequency road freight and container haulage from Mundra Port to Delhi-NCR, Jaipur, Ahmedabad, Mumbai, Pune, Indore, Bengaluru, and pan-India industrial centers.",
    category: "Highway Freight",
    keyCapability: "Mundra Port Haulage, FTL & Multi-Axle Trailers",
    heroBadge: "ROAD TRANSPORTATION • MUNDRA & PAN-INDIA",
    heroHeadline: "Road Transport from Mundra Port & Pan-India Freight",
    heroSubheadline: "Pan-India road transportation network anchored at Mundra Port, connecting maritime gateways, factories, warehouses, and industrial corridors with speed, safety, and live telemetry.",
    heroDescription: "High-frequency road freight corridors connecting Mundra Port to Delhi-NCR, Rajasthan, Maharashtra, MP, Karnataka, and nationwide industrial hubs.",
    heroImage: "https://res.cloudinary.com/uorctww6/image/upload/v1789377046/arrowline/general/road-transport.jpg",
    highlights: ["MUNDRA PORT HAULAGE", "FTL & LTL CORRIDORS", "ODC & HEAVY HAULAGE", "PAN-INDIA ROAD NETWORK"],
    aboutBadge: "ROAD TRANSPORTATION",
    aboutHeading: "Connecting Mundra Port Directly to Factories & Industrial Corridors Across India.",
    aboutDescription: "Arrowline Logistics delivers premier cargo transportation in India through a road freight network built on reliability, GPS-tracked fleet discipline, and seamless port-to-factory integration. Anchored at Mundra Port, Gujarat—the trade gateway to Northern and Western India—we orchestrate dedicated highway movements across Delhi NCR, Rajasthan, Maharashtra, Madhya Pradesh, Karnataka, Telangana, Tamil Nadu, and pan-India destinations. From single container chassis dispatches to complex multi-axle heavy-haul convoys, our operations guarantee on-time transit and zero-damage delivery.",
    aboutBulletPoints: [
    ...
    seoTitle: "Road Transport from Mundra Port & Pan-India Freight Services | Arrowline",
    seoDesc: "Reliable road cargo transportation and container haulage from Mundra Port to Delhi-NCR, Jaipur, Mumbai, Pune, Indore, Bengaluru, Kolkata, and Pan-India. FTL, trailers & ODC.",
    isPublished: true,
    displayOrder: 1,
  ...
  },
  {
    ...
    shortDesc: "Cost-effective, scheduled container rail trains and bulk freight rakes connecting Mundra Port with ICDs and industrial hubs across India.",
    category: "Rail Logistics",
    keyCapability: "WDFC Container Trains & Bulk Freight Rakes",
    heroBadge: "RAIL TRANSPORTATION • MUNDRA & PAN-INDIA",
    heroHeadline: "Rail Transportation & Container Train Logistics from Mundra Port",
    heroSubheadline: "Scheduled double-stack container trains and dedicated freight rakes connecting Mundra Port with inland dry ports (ICDs) and industrial hubs across India.",
    heroDescription: "High-speed container train and bulk rake rail freight from Mundra Port to Delhi-NCR, Jaipur, and nationwide ICD dry ports via Western Dedicated Freight Corridor.",
    heroImage: "https://res.cloudinary.com/uorctww6/image/upload/v1789377045/arrowline/general/rail-multimodal.jpg",
    ...
    seoTitle: "Rail Transportation Services India | Mundra Container Rail & WDFC | Arrowline",
    seoDesc: "High-speed container train and bulk rake rail freight from Mundra Port to Delhi-NCR, Jaipur, and nationwide ICD dry ports via Western Dedicated Freight Corridor.",
    isPublished: true,
    displayOrder: 2,
  ...
  },
  {
    ...
    slug: "project-cargo-transportation",
    title: "Project Cargo Transportation",
    shortDesc: "Turnkey engineering, hydraulic multi-axle pullers, and heavy-lift logistics for over-dimensional (ODC) cargo and plant machinery from Mundra Port across India.",
    category: "Specialized Project Logistics",
    keyCapability: "Engineered ODC, Multi-Axle Pullers & EPC Logistics",
    heroBadge: "PROJECT CARGO • MUNDRA & PAN-INDIA",
    heroHeadline: "Project Cargo & ODC Heavy Haulage from Mundra Port",
    heroSubheadline: "Engineered heavy-lift transportation, route surveys, multi-axle hydraulic pullers, and turnkey project logistics connecting Mundra Port with industrial sites across India.",
    heroDescription: "Specialized project cargo, heavy lift, and ODC transportation from Mundra Port to project sites across India. Hydraulic multi-axles, route surveys, and EPC staging.",
    heroImage: "https://res.cloudinary.com/uorctww6/image/upload/v1789377041/arrowline/general/project-cargo.jpg",
    ...
    seoTitle: "Project Cargo Transportation from Mundra Port | ODC Heavy Haulage | Arrowline",
    seoDesc: "Specialized project cargo, heavy lift, and ODC transportation from Mundra Port to project sites across India. Hydraulic multi-axles, route surveys, and EPC staging.",
    isPublished: true,
    displayOrder: 3,
  ...
  },
  {
    ...
    heroBadge: "WAREHOUSING • MUNDRA & PAN-INDIA",
    heroHeadline: "Industrial Warehousing & Container Storage Near Mundra Port",
    heroSubheadline: "State-of-the-art covered industrial storage, off-dock container handling yards, and distribution hubs strategically situated minutes from Mundra Port.",
    heroDescription: "Strategic industrial warehousing, off-dock CFS container yards, buffer storage, and distribution facilities located near Mundra Port, Gujarat with Arrowline Logistics.",
    heroImage: "https://res.cloudinary.com/uorctww6/image/upload/v1789377044/arrowline/general/project-warehouse.jpg",
    ...
    seoTitle: "Warehousing Near Mundra Port | Industrial Storage & CFS Yards | Arrowline",
    seoDesc: "Strategic industrial warehousing, off-dock CFS container yards, buffer storage, and distribution facilities located near Mundra Port, Gujarat with Arrowline Logistics.",
    isPublished: true,
    displayOrder: 4,
