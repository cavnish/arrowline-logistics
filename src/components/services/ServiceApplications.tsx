...
export default function ServiceApplications({ serviceName, applications }: ServiceApplicationsProps) {
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-12 sm:mb-16">
          ...
          <Reveal delay={80}>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-[#062B3A] tracking-tight">
              What We Transport & Handle
            </h2>
          </Reveal>

          <Reveal delay={140}>
            <p className="text-sm sm:text-base text-slate-600 leading-relaxed max-w-2xl mx-auto">
              Specialized handling protocols configured specifically for {serviceName.toLowerCase()} cargo profiles.
            </p>
          </Reveal>
        </div>
            ...
            <Reveal key={index} delay={index * 60}>
              <div className="group relative rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl border border-slate-200 bg-white transition-all duration-300 hover:-translate-y-1 flex flex-col h-full">
                ...
                <div className="relative aspect-[4/3] overflow-hidden bg-slate-100">
                  <img
                    src={app.image || "/images/road-transport.jpg"}
                    alt={app.title}
                    loading="lazy"
